...
public class ContinueWithRiceOrder extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        {
            tl1.setText("Basmati (kg)");
            tr1.setText(ap);
        }
        if (Integer.parseInt(or) > 0)
        {
            tl2.setText("Brown (kg)");
            tr2.setText(or);
        }
        if (Integer.parseInt(man) > 0)
        {
            tl3.setText("Masuri (kg)");
            tr3.setText(man);
        }
        if (Integer.parseInt(wm) > 0)
        {
            tl4.setText("Sanakki (kg)");
            tr4.setText(wm);
        }
    ...
    public void ret()
    {
        Intent i = new Intent(ContinueWithRiceOrder.this, CustomerBuying1.class);
