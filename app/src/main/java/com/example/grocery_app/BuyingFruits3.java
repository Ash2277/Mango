...
public class BuyingFruits3 extends AppCompatActivity
{
    ...
    public void addt1()
{
    ...
    public void ret()
    {
        Intent i = new Intent(BuyingFruits3.this, CustomerBuying3.class);
        startActivity(i);
        finish();
    }
    ...
    public void cont()
    {
        Intent i = new Intent(BuyingFruits3.this, ContinueWithFruitOrder.class);
