...
public class BuyingRice1 extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_buying_rice);
    ...
    public void addt1()
    {
        ...
        if(Integer.parseInt(s) <= 25)
        {
            ...
            t1.setText(s);
            sp1 = Integer.toString(319 * Integer.parseInt(s));
    ...
    public void addt2()
    {
        ...
        if(Integer.parseInt(s) <= 20)
        {
            ...
            t2.setText(s);
            sp2 = Integer.toString(319 * Integer.parseInt(s));
    ...
    public void addt3()
    {
        ...
        if(Integer.parseInt(s) <= 12)
        {
            s = Integer.toString(1 + Integer.parseInt(s));
            t3.setText(s);
            sp3 = Integer.toString(499 * Integer.parseInt(s));
    ...
    public void addt4()
    {
        ...
        if(Integer.parseInt(s) <= 22)
        {
            s = Integer.toString(1 + Integer.parseInt(s));
            t4.setText(s);
            sp4 = Integer.toString(420 * Integer.parseInt(s));
    ...
    public void ret()
    {
        Intent i = new Intent(BuyingRice1.this, CustomerBuying1.class);
        startActivity(i);
        finish();
    }
