...
public class BuyingGrains1 extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_buying_grains);
    ...
    public void ret()
    {
        Intent i = new Intent(BuyingGrains1.this, CustomerBuying1.class);
