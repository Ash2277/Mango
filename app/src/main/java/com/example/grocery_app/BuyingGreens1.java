...
public class BuyingGreens1 extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_buying_greens);
    ...
    public void addt1()
    {
        ...
        if(Integer.parseInt(s) <= 25)
        {
            ...
            t1.setText(s);
            sp1 = Integer.toString(140 * Integer.parseInt(s));
    ...
    public void addt2()
    {
        ...
        if(Integer.parseInt(s) <= 20)
        {
            ...
            t2.setText(s);
            sp2 = Integer.toString(13 * Integer.parseInt(s));
    ...
    public void addt3()
    {
        ...
        if(Integer.parseInt(s) <= 12)
        {
            s = Integer.toString(1 + Integer.parseInt(s));
            t3.setText(s);
            sp3 = Integer.toString(154 * Integer.parseInt(s));
    ...
    public void addt4()
    {
        ...
        if(Integer.parseInt(s) <= 22)
        {
            s = Integer.toString(1 + Integer.parseInt(s));
            t4.setText(s);
            sp4 = Integer.toString(15 * Integer.parseInt(s));
    ...
    public void ret()
    {
        Intent i = new Intent(BuyingGreens1.this, CustomerBuying1.class);
    ...
    public void cont()
    {
        Intent i = new Intent(BuyingGreens1.this, ContinueWithGreensOrder.class);
        cost += Integer.parseInt(sp1) + Integer.parseInt(sp2) + Integer.parseInt(sp3) + Integer.parseInt(sp4);
        i.putExtra("cost", Integer.toString(cost));
        i.putExtra("palak", t1.getText());
        i.putExtra("coriander", t2.getText());
        i.putExtra("kale", t3.getText());
        i.putExtra("curry", t4.getText());
        startActivity(i);
        finish();
    }
