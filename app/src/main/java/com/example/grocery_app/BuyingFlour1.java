...
public class BuyingFlour1 extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_buying_flour);
    ...
    public void ret()
    {
        Intent i = new Intent(BuyingFlour1.this, CustomerBuying1.class);
    ...
    public void cont()
    {
        Intent i = new Intent(BuyingFlour1.this, ContinueWithFlourOrder.class);
        cost += Integer.parseInt(sp1) + Integer.parseInt(sp2) + Integer.parseInt(sp3) + Integer.parseInt(sp4);
        i.putExtra("cost", Integer.toString(cost));
        i.putExtra("wheat", t1.getText());
        i.putExtra("rice", t2.getText());
        i.putExtra("almond", t3.getText());
        i.putExtra("all", t4.getText());
        startActivity(i);
        finish();
    }
